...
$(TEST_BIN): tests/test_distribution.c $(REF_OBJ) $(CDT_OBJ) $(RANDOMCOINS_OBJ) | $(BIN_DIR)
	$(CC) $(CPPFLAGS) $(CFLAGS) $(WARNFLAGS) -o $@ \
		tests/test_distribution.c $(REF_OBJ) $(CDT_OBJ) $(RANDOMCOINS_OBJ) $(LDLIBS)

$(BENCH_BIN): bench/bench_sampler.c $(REF_OBJ) $(CDT_OBJ) $(RANDOMCOINS_OBJ) | $(BIN_DIR)
	$(CC) $(CPPFLAGS) $(CFLAGS) $(WARNFLAGS) -o $@ \
		bench/bench_sampler.c $(REF_OBJ) $(CDT_OBJ) $(RANDOMCOINS_OBJ) $(LDLIBS)

clean:
	rm -f $(REF_OBJ) $(CDT_OBJ) $(RANDOMCOINS_OBJ) $(TEST_BIN) $(BENCH_BIN)
